      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/Adventure-travel-is-making-a-hug.jpg" alt="Image placeholder" class="img-fluid rounded">
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/sya.png" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Choun Satya</h3>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/van.png" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Nhor Van</h3>
                  <p class="block-38-subheading">Member</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
